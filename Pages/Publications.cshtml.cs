    ...
    public class PublicationsModel : PageModel
    {
        ...
        public List<Publications> GetPublicationInfo()
        {
            ...
            List<Publications> output = new List<Publications>
            {
                ...
                new Publications
                {
                    PurchaseBtn = "<button class='Publication-Button' type='button' onclick=\"window.location.href='https://www.amazon.com/Suffer-Children-tragic-legacies-Bushnell-ebook/dp/B072FHM89F'\" target='blank'>Click to purchase <span class='material-icons md-10'>shopping_cart</span></button>",
                ...
                new Publications
                {
                    PurchaseBtn = "<button type='button' class='Publication-Button' onclick=\"window.location.href='https://www.amazon.com/Blight-Islam-Revised-John-Waldrip-ebook/dp/B07HLLNHCC/'\" target='blank'> Click to Purchase (Amazon) <span class='material-icons md-10'>shopping_cart</span></button> <br/> <button class='Publication-Button' id='checkout-button-sku_G95Ms5hhIOHwyh' role='link' type='button' >Click to Purchase (Secure Site) <span class='material-icons md-10'>shopping_cart</span></button>",
                    Device = "Kindle Edition",
                ...
                new Publications
                {
                    PurchaseBtn ="<button type='button' class='Publication-Button' onclick=\"window.location.href='./assets/polemicTheology.pdf'\" target='blank'> Click to read  <span class='material-icons md-10'>auto_stories</span></button>",
                    Device = "Online",
                ...
                new Publications
                {
                    PurchaseBtn = "<button type='button' class='Publication-Button' onclick=\"window.location.href='./assets/Halloween_A_Result_of_Religious_Apostasy.pdf'\" target='blank'> Click to read <span class='material-icons md-10'>auto_stories</span></button>",
                    Device = "Online",
